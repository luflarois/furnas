...
module utilsMod
    ...
    function hypsometric(sea_press,press,temp) result(high)
       !! ## Rettur the higth from sea level 
       !!
       !! Author: Rodrigues, L. F. [LFR]
       !!
       !! E-mail: <mailto:luizfrodrigues@protonmail.com>
       !!
       !! Date: 07Setembro2023 15:20
       !!
       !! #####Version: 0.1.0
       !!
       !! ---
       ...
       implicit none
       ! Parameters:
       character(len=*), parameter :: p_procedure_ame = 'hypsometric' 
       !! Function name
       real, parameter :: t_zero=273.15
       !! Absolute zero
       real, parameter :: fact= 1/5.257
    
       ! Variables (input):
       real, intent(in) :: sea_press
      ...
      high = (((sea_press/press)**fact-1)*(temp+t_zero))/0.0065
